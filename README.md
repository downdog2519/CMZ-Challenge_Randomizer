# CMZ Challenge Generator

**Live / repo:** https://github.com/downdog2519/CMZ-Challenge_Randomizer

Open the web app from the `app/` folder (`app/index.html`), or run desktop with Electron (`npm start`).

## Project Overview

**CMZ Challenge Generator** is a BO7 Zombies challenge randomizer (Electron + static web) with relics, profiles, Relic Codex unlock guides, and CMZ branding.
...
## New Features (v2.2.0)
- **Relic Codex:** Full unlock steps for all 30 relics across 5 cursed maps.
- **Totenreich + Kowakujo:** Maps, relics, trail/boss/starting pools.
- **CMZ branding:** Seal, gold UI, menu background, refreshed map panels.
- **Victory results:** Pass/fail celebration bursts + epic summary screen.
- **Fairer randomizer:** Crypto RNG, Fisher–Yates shuffle, equal map weights.
